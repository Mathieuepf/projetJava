                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="car" name="car" autocomplete="on">
                                            <option value="${currentVehicle.getId()}">${currentVehicle.getConstructeur()} ${currentVehicle.getModele()}</option>
                                            <c:forEach items="${vehicles}" var="vehicle">
                                                <option value="${vehicle.getId()}">${vehicle.getConstructeur()} ${vehicle.getModele()}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="begin" name="begin" required
                                               data-inputmask="'alias': 'dd/mm/yyyy'" value="${debut}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="end" name="end" required
                                               data-inputmask="'alias': 'dd/mm/yyyy'" value="${fin}">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
